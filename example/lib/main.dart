...
class _MyAppState extends State<MyApp> {
  List<DisplayModeJson> modes = <DisplayModeJson>[];
  DisplayModeJson? active;
  DisplayModeJson? preferred;
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    child: ListView.builder(
                      ...
                      itemBuilder: (_, int i) {
                        final DisplayModeJson mode = modes[i];
                        return Row(
                          children: <Widget>[
                            Radio<DisplayModeJson>(
                              value: mode,
                              groupValue: preferred,
                              onChanged: (DisplayModeJson? newMode) async {
